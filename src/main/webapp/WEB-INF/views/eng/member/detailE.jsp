    ...
    <div class="sub_top sub_top_member">
        <div class="inner">
            <div class="sub_top_txt">
                ...
                <div class="sub_top_tit">Cooperative Organization</div>
            </div>
            <div class="sub_top_tab">
                <div class="tabOptAct">Cooperative Organization</div>
                <ul class="tabOptSel">
                    ...
                    <li class="active"><a href="/eng/member/partnership.do">Cooperative Organization</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="thumb169 thumbBox">
                                <c:choose>
                                    <c:when test = "${logoFileInfo ne null and logoFileInfo ne ''}">
                                        ...
                                        <img src="${logoImgSrc}" class="thumbImg thumbLogo" alt="logo_Image">
                                    </c:when>
                                    <c:otherwise>
                                        <img src="<%request.getContextPath();%>/static/img/img_nologo.jpg" class="thumbImg thumbLogo" alt="no_logo_Image">
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
