        ...
        <div class="inner">
            ...
            <div class="sub_top_tab">
                ...
                <ul class="tabOptSel">
                    ...
                    <li class="active"><a href="/support/bidanm.do">입찰공고</a></li>
        ...
        <div class="inner">
            <form class="search_box" onsubmit="return false;">
                <select id="search_box">
                    <option value="NAME" selected>입찰공고명</option>
                    <option value="ORG">사업수행기관</option>
                    <option value="CONTENT">내용</option>
                </select>
                <div class="input">
                    <input type="text" id="search_text" placeholder="검색어를 입력해주세요.">
                    <button type="button" onclick="bidanmList(1)"><img src="<%request.getContextPath();%>/static/img/icon_search.png"></button>
                </div>
            </form>
...
<script src="<%request.getContextPath();%>/static/js/front/bidanm.js?ver=<%=System.currentTimeMillis()%>"></script>
