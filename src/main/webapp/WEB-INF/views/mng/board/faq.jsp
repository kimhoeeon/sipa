                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_board_faq_table', 'FAQ')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::신규 등록-->
                                                <a href="javascript:void(0);" onclick="f_board_faq_modify_init_set('');" class="btn btn-primary ms-auto">신규 등록</a>
                                                <!--end::신규 등록-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
