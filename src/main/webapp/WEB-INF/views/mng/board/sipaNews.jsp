...
<c:if test="${status eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/board/sipaNews.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">SIPA-NEWS</span>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">SIPA-NEWS</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_board_sipa_news_table', 'SIPA-NEWS')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-allow-clear="true" data-hide-search="true" onchange="f_board_sipa_news_search()">
                                                    <option></option>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_board_sipa_news_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_board_sipa_news_search_condition_init()" class="btn btn-secondary me-5">
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::신규 등록-->
                                                <a href="javascript:void(0);" onclick="f_board_sipa_news_modify_init_set('');" class="btn btn-primary ms-auto">신규 등록</a>
                                                <!--end::신규 등록-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_board_sipa_news_table">
                                            <thead>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">SIPA-NEWS 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
    ...
    <script src="<%request.getContextPath();%>/static/js/mng/sipaNews.js?ver=<%=System.currentTimeMillis()%>"></script>
