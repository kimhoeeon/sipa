                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_company_issue_table', 'Issue_Trend')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-allow-clear="true" data-hide-search="true" onchange="f_company_issue_search()">
                                                    <option></option>
                                                    <option disabled>- 검색조건 -</option>
                                                    <option value="all" selected>전체</option>
                                                    <option value="bizName">제목</option>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_company_issue_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_company_issue_search_condition_init()" class="btn btn-secondary me-5">
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::등록-->
                                                <a href="javascript:void(0);" onclick="f_company_issue_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::등록-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_company_issue_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="text-center min-w-125px">발행처</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">Issue&Trend 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_support_field" placeholder="분류" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_support_biz_name" placeholder="제목" readonly>
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_ministry_competent" placeholder="발행처" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
