...
<c:if test="${status eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/company/issue.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Issue&Trend</span>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Issue&Trend</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <!--begin::Select2-->
                                                    <select id="supportField" name="supportField" class="form-select form-select-solid" data-control="select2" aria-label="- 분류 -" data-placeholder="- 분류 -" data-allow-clear="true" data-hide-search="true">
                                                        <option></option>
                                                        <option value="" disabled>- 분류 -</option>
                                                        <option value="기술정책동향" <c:if test="${info.supportField eq '기술정책동향'}">selected</c:if> >기술정책동향</option>
                                                        <option value="언론보도" <c:if test="${info.supportField eq '언론보도'}">selected</c:if> >언론보도</option>
                                                        <option value="칼럼" <c:if test="${info.supportField eq '칼럼'}">selected</c:if> >칼럼</option>
                                                    </select>
                                                    <!--end::Select2-->
                                                </div>
                                                <!--end::Col-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="supportBizName" name="supportBizName" class="form-control form-control-lg form-control-solid-bg" placeholder="제목" value="${info.supportBizName}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">발행처</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <input type="text" id="ministryCompetent" name="ministryCompetent" class="form-control form-control-lg form-control-solid-bg" placeholder="발행처" value="${info.ministryCompetent}"/>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/company/issue.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_company_issue_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                            <button type="button" onclick="f_company_issue_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="ms-10">
                            <!--begin::File upload-->
                            <a onclick="f_attach_file_upload('${info.seq}','modal_file_upload_form','company/issue')" class="btn btn-primary">업로드</a>
                            <!--end::File upload-->
                        </div>
                        <!--end::Col-->
                    </div>
    ...
    <script src="<%request.getContextPath();%>/static/js/mng/issue.js?ver=<%=System.currentTimeMillis()%>"></script>
    <!--end::Custom Javascript-->
