                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_pop_banner_table', '배너')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_pop_banner_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_pop_banner_search_condition_init()" class="btn btn-secondary me-5">
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::신규 등록-->
                                                <a href="javascript:void(0);" onclick="f_pop_banner_modify_init_set('');" class="btn btn-primary ms-auto">등록</a>
                                                <!--end::신규 등록-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_pop_banner_table">
                                            <thead>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">배너 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_view_seq" placeholder="노출순서" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
