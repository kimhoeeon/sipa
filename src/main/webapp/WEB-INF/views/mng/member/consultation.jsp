...
<c:if test="${status eq 'logon'}">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion hover show">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="/mng/member/consultation.do">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">자문위원</span>
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">자문위원</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_member_consultation_table', '자문위원')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-allow-clear="true" data-hide-search="true" onchange="f_member_consultation_search()">
                                                    <option></option>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_member_consultation_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_member_consultation_search_condition_init()" class="btn btn-secondary me-5">
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::신규 등록-->
                                                <a href="javascript:void(0);" onclick="f_member_consultation_modify_init_set('');" class="btn btn-primary ms-auto">신규 등록</a>
                                                <!--end::신규 등록-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_member_consultation_table">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="text-center min-w-50px">번호</th>
                                                    <th>seq</th>
                                                    <th class="text-center min-w-50px">언어</th>
                                                    <th class="text-center min-w-50px">협회직위</th>
                                                    <th class="text-center min-w-75px">성명</th>
                                                    <th class="text-center min-w-100px">소속기관</th>
                                                    <th class="text-center min-w-100px">직위</th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #1e1e2d;">
                    <!--begin::Modal title-->
                    <h2 style="color: #FFFFFF;">고문위원 정보 상세보기</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                <!--begin::Label-->
                                <label class="form-label">협회직위</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_position" placeholder="협회직위" readonly>
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_name" placeholder="성명" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                <!--begin::Label-->
                                <label class="form-label">소속기관</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_organization" placeholder="소속기관" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_depart" placeholder="직위" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_homepage" placeholder="홈페이지" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-lg form-control-solid-bg mb-2" id="md_tel" placeholder="연락처" readonly>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10">
                                <!--begin::Label-->
                                <label class="form-label">약력사항</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea class="form-control form-control-lg form-control-solid-bg mb-2" id="md_briefDescription" placeholder="약력사항" readonly></textarea>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
    ...
    <script src="<%request.getContextPath();%>/static/js/mng/consultation.js?ver=<%=System.currentTimeMillis()%>"></script>
