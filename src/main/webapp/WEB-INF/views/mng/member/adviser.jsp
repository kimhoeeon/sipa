                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-full d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <button type="button" onclick="f_excel_export('mng_member_adviser_table', '고문위원')" class="btn btn-success btn-active-light-success" data-kt-export="excel" data-kt-menu-placement="bottom-end">
                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card card-flush">
                                        ...
                                        <div class="card-title w-100">
                                            ...
                                            <div class="w-100 mw-150px">
                                                ...
                                                <select id="search_box" class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        data-allow-clear="true" data-hide-search="true" onchange="f_member_adviser_search()">
                                                    <option></option>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <button type="button" onclick="f_member_adviser_search()" class="btn btn-primary me-5">Search</button>
                                                <button type="button" onclick="f_member_adviser_search_condition_init()" class="btn btn-secondary me-5">
                                            ...
                                            <div class="ms-auto">
                                                <!--begin::신규 등록-->
                                                <a href="javascript:void(0);" onclick="f_member_adviser_modify_init_set('');" class="btn btn-primary ms-auto">신규 등록</a>
                                                <!--end::신규 등록-->
                                            </div>
                                        </div>
                                        <!--end::Card title-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="mng_member_adviser_table">
                                            <thead>
