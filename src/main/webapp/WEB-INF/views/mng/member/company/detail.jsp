                            ...
                            <div id="kt_app_content_container" class="app-container container-full">
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <form id="dataForm" method="post" onsubmit="return false;">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">회원 구분</label>
                                                <!--begin::Label-->
                                                <!--begin::Label-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <div class="form-check form-check-custom">
                                                        <input class="form-check-input form-control-solid-bg" type="radio" id="gbnR" name="gbn" value="R" <c:if test="${info.gbn eq 'R'}">checked</c:if> />
                                                        <label class="form-check-label" for="gbnR">
                                                            정회원
                                                        </label>
                                                        <input class="form-check-input form-control-solid-bg ml20" type="radio" id="gbnA" name="gbn" value="A" <c:if test="${info.gbn eq 'A' or empty info}">checked</c:if> />
                                                        <label class="form-check-label" for="gbnA">
                                                            준회원
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <!--begin::Description-->
                                                            <div class="text-danger fs-7">이미지 사이즈 : 600x380 이상 권장, 16:9 비율</div>
                                                            <!--end::Description-->
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                    ...
                                                    <ul id="uploadFileList">
                                                        <c:forEach var="file" items="${fileList}">
                                                            <li class="mb-4">
                                                                ...
                                                                <a href="/file/download.do?path=member/company/${file.folderPath}&fileName=${file.fullFileName}">${file.fileName}</a>
                                ...
                                <div class="card mb-5 mb-xl-10">
                                    ...
                                    <div class="card-footer d-flex justify-content-between py-6 px-9">
                                        <div>
                                            <a href="/mng/member/company.do" class="btn btn-info btn-active-light-info" id="kt_list_btn">목록</a>
                                        </div>
                                        <div>
                                            <button type="button" onclick="f_member_company_modify_init_set('${info.seq}')" class="btn btn-danger btn-active-light-danger me-2">변경내용취소</button>
                                            <button type="button" onclick="f_member_company_save('${info.seq}')" class="btn btn-primary btn-active-light-primary" id="kt_save_submit">변경내용저장</button>
                                        </div>
                                    </div>
                                    <!--end::Actions-->
                                </div>
