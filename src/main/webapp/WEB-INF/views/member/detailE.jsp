    ...
    <div class="sub_top sub_top_member">
        <div class="inner">
            <div class="sub_top_txt">
                ...
                <div class="sub_top_tit">협력기관</div>
            </div>
            <div class="sub_top_tab">
                <div class="tabOptAct">협력기관</div>
                <ul class="tabOptSel">
                    ...
                    <li class="active"><a href="/member/partnership.do">협력기관</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="thumb169 thumbBox">
                                <c:choose>
                                    <c:when test = "${logoFileInfo ne null and logoFileInfo ne ''}">
                                        ...
                                        <img src="${logoImgSrc}" class="thumbImg thumbLogo" alt="로고_이미지">
                                    </c:when>
                                    <c:otherwise>
                                        <img src="<%request.getContextPath();%>/static/img/img_nologo.jpg" class="thumbImg thumbLogo" alt="로고_이미지_없음">
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
