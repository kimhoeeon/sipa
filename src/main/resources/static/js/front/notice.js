...
function searchPosts(pageNum) {
    ...
    $.ajax({
        url: '/community/notice/selectList.do',
        method: 'post',
    ...
    .done(function (data, status){
        ...
        $.each(results , function(i){
            ...
            if(noticeGbn === '1'){
                ...
                if(lang === 'KO'){
                    str += '<div class="tit" onclick="location.href=\'/community/notice/detail.do?seq=' + seq + '\'">';
                }else{
                    str += '<div class="tit" onclick="location.href=\'/eng/community/notice/detail.do?seq=' + seq + '\'">';
                }
                        str += title;
                    str += '</div>';
                    str += '<div class="date">';
